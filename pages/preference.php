...
<?php include("../templates/header.php") ?>
                    ...
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <button class="edit-button" onclick="openEditModal(<?php echo $row["id_reading_wishlist"]; ?>)">Edit</button>
                                    <form action="../includes/deletePreference.php" method="POST">
                                        <input type="hidden" name="id_reading_wishlist" value="<?php echo $row["id_reading_wishlist"]; ?>">
    ...
    <div id="addPreference" class="modal">
        <div class="modal-content">
            ...
            <form class="form-content" action="../includes/createPreference.php" method="POST">
                <div class="input-content">
                    <label for="book_title">Títle:</label>
    ...
    <div id="editPreference" class="modal">
        <div class="modal-content">
            ...
            <form class="form-content" action="../includes/editPreference.php" method="POST">
            <input type="hidden" id="edit_id_reading_wishlist" name="id_reading_wishlist" value="">
                <div class="input-content">
                    <label for="book_title">Title:</label>
                    <input class="input-modal" type="text" id="book_title" name="book_title" required value="<?php echo htmlspecialchars($title); ?>">
                </div>
                <div class="input-content">
                    <label for="author">Author:</label>
                    <input class="input-modal" type="text" id="author" name="author" required value="<?php echo htmlspecialchars($author); ?>">
                </div>
                <div class="input-content">
                    <label for="genre">Genre:</label>
                    <input class="input-modal" type="text" id="genre" name="genre" value="<?php echo htmlspecialchars($genre); ?>">
                </div>
                <div class="input-content">
                    <label for="publication_year">Publication Year:</label>
                    <input class="input-modal" type="number" id="publication_year" name="publication_year" value="<?php echo htmlspecialchars($publication_year); ?>">
                </div>
                <div class="input-content">
                    <label for="reason_for_reading">Reason for reading:</label>
                    <textarea id="reason_for_reading" name="reason_for_reading"><?php echo htmlspecialchars($reason_for_reading); ?></textarea>
                </div>
                <div class="input-content">
